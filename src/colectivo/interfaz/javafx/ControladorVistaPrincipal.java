...
import colectivo.datos.CargarDatos; // Para obtener las paradas
...
/**
 * Controlador para la interfaz gráfica definida en VistaPrincipal.fxml.
 * Maneja la interacción del usuario y la lógica de la vista.
 */
public class ControladorVistaPrincipal implements Initializable { // Implementa Initializable
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        // Llenar ComboBoxes de Paradas (usando los datos ya cargados)
        // Asegúrate de que CargarDatos.getParadasCargadas() funcione
        List<Parada> paradasDisponibles = CargarDatos.getParadasCargadas() != null ?
                new ArrayList<>(CargarDatos.getParadasCargadas().values()) :
                new ArrayList<>();

        if (!paradasDisponibles.isEmpty()) {
            // Convertir la lista a una ObservableList para los ComboBox
            ...
            System.err.println("Advertencia: No se pudieron cargar las paradas en los ComboBox.");
            // Podrías mostrar una alerta al usuario aquí si quieres
        }
    }
    ...
    /**
     * Muestra los resultados calculados en el TextArea.
     * (Similar al método que tenías en InterfazJavaFX)
     *
    ...
    public void mostrarResultados(List<List<Recorrido>> listaRecorridos) {
        ...
        for (List<Recorrido> r : listaRecorridos) {
            ...
            for (Recorrido recorrido : r) {
                ...
                sb.append("  Línea: ").append(recorrido.getLinea() != null ? recorrido.getLinea().getCodigo() : "Caminando").append("\n");
                sb.append("  Desde: ").append(recorrido.getParadas().get(0).getDireccion()).append("\n");
                sb.append("  Hasta: ").append(recorrido.getParadas().get(recorrido.getParadas().size() - 1).getDireccion()).append("\n");
                sb.append("  Sale a las: ").append(recorrido.getHoraSalida()).append("\n");
                sb.append("  Duración: ").append(recorrido.getDuracion()).append(" segundos\n\n"); // Asumiendo que duración está en segundos
            }
            contador++;
        }
    ...
    /**
     * Método para inyectar la dependencia del Coordinador.
     * Deberás llamarlo desde tu clase principal (AplicacionConsultas)
    ...
    public void setCoordinador(Coordinador coordinador) {
        ...
        // Podrías inicializar más cosas aquí si dependen del coordinador
    }
